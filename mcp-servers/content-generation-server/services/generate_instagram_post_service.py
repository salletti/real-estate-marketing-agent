...
from prompts.instagram_post_prompt import INSTAGRAM_POST_TEMPLATE
...
class GenerateInstagramPostService:

    def __init__(self, llm_client: Optional[LLMClient] = None):
        self._llm = llm_client or LLMClient()

    def generate(self, property: Property) -> Dict[str, Any]:
        prompt = INSTAGRAM_POST_TEMPLATE.format(**_to_prompt_vars(property))
